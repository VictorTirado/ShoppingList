...
public class ShoppingListActivity extends AppCompatActivity {
    ...
    public void OnDeleteItem(final int position)
    {
        ...
        String deleteText = "Deleting " + items.get(position).getName() + " from list";
        builder.setTitle("Confirm")
                .setMessage(deleteText)
                .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(ShoppingListActivity.this, "deleted " + items.get(position).getName() +  " see you", Toast.LENGTH_SHORT).show();
